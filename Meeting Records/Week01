# List of Games
In our first meeting for the Software Engineer Discipline and Principle project, each team member proposed 2-3 game ideas for discussion. We evaluated these ideas based on feasibility, creativity, technical complexity, and alignment with course objectives. Some of the key considerations included game mechanics, potential challenges, required resources, and implementation scope.

During the discussion, we categorized the ideas into different genres. Some members suggested multiplayer or AI-driven components to enhance engagement. We also discussed potential technologies and frameworks for development, considering factors like ease of implementation, scalability, and learning value.

By the end of the meeting, we compiled a shortlist of the most promising ideas. The next step is for each member to conduct further research on the shortlisted concepts and present a more detailed feasibility analysis in the next meeting. The final game concept will be selected based on these findings.
